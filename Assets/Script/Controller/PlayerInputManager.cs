...
public class PlayerInputManager : MonoBehaviour
{
    ...
    private string GetTextButtonInput(string moveP, string holP)
    {
    ...
    void Awake()
    {
        ...
        {
            if (playerControllers[i]._inputSetting == null)
            {
    ...
    void SetInput(int joypadCount)
    {
        switch (joypadCount)
        {
            case 0:
                ...
                stringList.Add(GetTextButtonInput(keyboard1Move, keyboard1Hold)); //String atama işlemeleri
                stringList.Add(GetTextButtonInput(keyboard2Move, keyboard2Hold));
                break;
            case 1:
                inputList.Add(keyboards[0]);
                inputList.Add(joypads[0]);

                stringList.Add(GetTextButtonInput(keyboard1Move, keyboard1Hold));
                stringList.Add(GetTextButtonInput(joypadMove, joypadHold));
                break;
            case 2:
                inputList.Add(keyboards[0]);
                inputList.Add(keyboards[1]);
    ...
    void SetPlayerControllerInput(int joypadCount)
    {
        if (joypadCount <= 1)
        {
            ...
            playerControllers[0]._inputSetting = inputList[0];
            playerControllers[2]._inputSetting = inputList[1];
        ...
        else
        {
            ...
            playerControllers[0]._inputSetting = inputList[0];
            playerControllers[1]._inputSetting = inputList[1];
            playerControllers[2]._inputSetting = inputList[2];
            playerControllers[3]._inputSetting = inputList[3];
